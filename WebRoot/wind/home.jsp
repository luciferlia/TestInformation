...
<body>
		                    ...
		                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true" style="width:70%;height:100%;min-width:800px;margin-left:2%;margin-top:2%;float:left;">
		                            ...
		                            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
		                              <form>
		                                <div class="panel-body" style="min-height:200px;">
		                                    <p>
		                                   1.<a>陈玉兔  U10  项目   分配  TP 用例   200 条   给您。</a><br/>
		                                   2.<a>陈玉兔  U10  项目   分配  TP 用例   200 条   给您。</a><br/>
		                                   3.<a>陈玉兔  U10  项目   分配  TP 用例   200 条   给您。</a><br/> 
		                                   </p>
		                                </div>
		                                </form>
		                            </div>
		                        ...
		                        <div class="panel panel-default">
		                            ...
		                            <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
		                                <div class="panel-body" style="min-height:200px;">
		                                    <p>
		                                    1.<a href="project/project.jsp">魅族   客户  U10 项目  测试经理  沈霞 </a> <br/>
		                                    2.<a href="project/project.jsp">华硕   客户  E281 项目  测试经理  陈玉兔  </a><br/> 
		                                    3.<a href="project/project.jsp">联想   客户  A158 项目  测试经理  戚焕灵 </a><br/>  
		                                    </p>
		                                </div>
		                            </div>
		                        </div>
		                        ...
		                        <div class="panel panel-default">
		                            ...
		                            <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
		                                <div class="panel-body" style="min-height:200px;">
		                                    <p> 
		                                    1.<a href="">SIM卡资源   号码  18516315876 联通  1 张 </a> <br/>
		                                    2.<a href="">测试资源  路由器  华为  5.2协议  1台 </a><br/> 
		                                    3.<a href="">预约实验室   5  月  19  号  9:00 -- 11:00  实验室 1 号</a><br/>  
		                                    </p>
		                                </div>
		                            </div>
		                        </div>
          ...
          <tr>
          <td><span class="	glyphicon glyphicon-leaf"> <a href="http://redmine.wind-mobi.com/redmine/login" target="_blank">Redmine</a></span></td>
