...
<script>
	...
	function check(){ //提交前判断部分值是否为空
	var a=document.getElementsByName('cases.caseName')[0].value;//通过name查看对应值
...
<body>
<form action="Case_addCase?id=${id }" method="post"class="layui-form" onSubmit="return check();">
		<table
		...
		<tr>
			<td>
						...
						<div class="layui-inline">
							...
							<div class="layui-input-inline">
								<input type="text" name="cases.testItem" value=""
									 class="layui-input">
							</div>
						</div>
						<div class="layui-inline">
							...
							<div class="layui-input-inline">
								<input type="text" name="cases.num"
									 class="layui-input">
							</div>
						</div>
					</div>
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<select type="text" name="cases.level">
						...
						<div class="layui-input-inline">
							<textarea name="cases.description" class="layui-textarea"
								style="width: 500px;overflow-y:visible;"></textarea>
						</div>
					</div>
					<div class="layui-form-item layui-form-text">
						<label class="layui-form-label">预置条件</label>
						<div class="layui-input-inline">
							<textarea name="cases.environment" value=""
					...
					<div class="layui-form-item layui-form-text">
						...
						<div class="layui-input-inline">
							<textarea name="cases.step" value=""
								class="layui-textarea"  
								style="width: 500px;overflow-y:visible;"></textarea>
						</div>
					</div>
		...
		<tr style="height:40px;">
			<td><button type="submit" class="layui-btn layui-btn-normal layui-btn-radius" style="margin-left:70%;">保存</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<!-- 	<a  type="reset" href="wind/usecase.jsp" class="layui-btn layui-btn-normal layui-btn-radius">返回</a></td> -->
		</tr>
	</table>
	</form>
