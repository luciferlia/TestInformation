...
<body onload="MergeCell('cdTb', 0, 0, 0)">
	...
	<table style="width:90%;margin-left:1%;">
		<tr>
			...
			<td><span style="float:right;"><form action="task_showTakSchedule" class="right-font08">
						[
	...
	<c:if test="${empty pageBean.list }">
		<c:if test="${message=='' }">
		<center style="color:red;font-size:10px;">没有历史任务</center>
		</c:if>
