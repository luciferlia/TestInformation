    ...
    <body oncontextmenu="return false">
        ...
        <div class="page-container">
            ...
            <form action="Admin_Login" method="post">
				...
				<div>
					<input type="text" name="username" onkeyup="this.value=this.value.replace(/[^\w]/g,'');" class="username" placeholder="用户名" autocomplete="off" minlength="2" maxlength="18"/>
				</div>
                <div>
            ...
            <div class="connect">
                <p>WIND's management system for test project</p>
