 ...
 <table id="table1" style="display:none">
	...
	<table style="width:100%;min-width:1100px;" class="table"
		...
		<c:forEach items="${policy }" var="p">
			...
			<tr>
				<td><input type="text" name="status" value="${p.phase }" class="layui-input"></td>
				...
				<td><input type="text" name="count" value="${p.caseCount }" class="layui-input"></td>
				<td><input type="text" name="humannum" value="${p.humanInput }" class="layui-input"></td>
				<td><input type="text" name="humancount" value="${p.humanCount }" class="layui-input"></td>
				<td><input type="text" name="pcount" value="${p.prototypeCount }" class="layui-input"></td>
				<td><input type="text" name="preuse" value="${p.prototypeReuse }" class="layui-input"></td>
